...
import umc.spring.web.domain.mapping.MemberPrefer;
import umc.spring.web.domain.mapping.MemberReview;
...
public class Member extends BaseEntity {
    ...
    @Column(columnDefinition = "VARCHAR(10)") // type직접 지정
    ...
    @Enumerated(EnumType.STRING)
    @Column(columnDefinition = "VARCHAR(15) DEFAULT 'ACTIVE'") // 'ACTIVE'로 지정됨
    ...
    @OneToMany(mappedBy = "member", cascade = CascadeType.ALL)
    private List<MemberReview> memberReviesList = new ArrayList<>();
}